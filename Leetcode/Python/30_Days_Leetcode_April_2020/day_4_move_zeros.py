...
## There is one more in-place solution where keep all not zeors at the beginening and then append zeors while the size becomes equal to the original list
def move_zeros_list(nums):
    count = 0
